  ...
  return (
    <div className="h-full overflow-x-hidden py-16">
      ...
      <div className="grid lg:grid-cols-2 mx-auto w-full max-w-5xl gap-4 px-4">
        ...
        <div className="text-lg border p-8 bg-base-100 flex flex-col md:flex-row md:items-center md:gap-x-8 lg:flex-col lg:items-start justify-center items-start">
          {/* <div className="border mb-4 p-1">
          <img src={dp} alt="" className="w-full max-h-[120px]" />
        </div> */}
          <p className="text-base-content/80 font-light">
            You can view my Resume by clicking this button.
          </p>
          <a href={Resume} download target="_blank" rel="noopener noreferrer" className="flex items-center justify-center text-lg space-x-2 mt-8 md:mt-0 lg:mt-8 bg-base-300 py-3 w-full max-w-[12rem] text-center border transition-all duration-300 cursor-pointer hover:-translate-x-1 hover:-translate-y-1 hover:rounded-md hover:shadow-[4px_4px_0px_white]">
            <span>Download</span>
        ...
        <div className="text-lg lg:col-span-2 border p-8 bg-base-100 flex justify-center items-center">
          <p className="text-base-content/80 font-light">
            ...
            Apart from that, <span className="">expanding my knowledge</span> through learning new technologies are so important
